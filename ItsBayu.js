...
//━━━━━━━━━━━━━━━[ SETTING ]━━━━━━━━━━━━━━━━━//
owner = '628991544516'//Ganti No Lu
botname = 'NIGHT BOT'//Ganti Nama Bot Lu
zerokey = 'LolHumanzzh'//Jangan Di Ganti
ownername = 'Nata'//ganti Nama Lu
//━━━━━━━━━━━━━━━[ MODUL EXPORTS ]━━━━━━━━━━━━━━━━━//
...
module.exports = zeroyt7 = async (zeroyt7, mek, _welkom) => {
	try {
		...
		const ownerNumber = [`${owner}@s.whatsapp.net`, `6285894327468@s.whatsapp.net`]
...
"body": `hy`, 
"mediaType": "2", 
"mediaUrl": "https://youtu.be/j0gi63nMrlY", 
...
🤖 *Bot Name* : ${botname}
🎟️ *Type* : ${type}
💬 *No Owner* : wa.me/628991544516
🛐 *Donasi* : https://saweria.co/
👾 *Language* : JavaScript 
💌 *Email* : kamuggayuh@gmail.com
...
trans = `Please!! No Spam Bot!!!\n Fitur masih dikit Insya Allah Tar Di Tambah Lagi Jangan Lupa Subscribe My Chanel Mbp_17🌚`
...
break
case 'tebakumur':
if (args.length == 0) return reply(`Namanya Mana Tod\nContoh: ${prefix + command} BayuGanteng`)
ini_name = args.join(" ")
...
sendButton(from, "GOPAY : 085709898902", faketeks, but, mek)
break
case 'dana':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "DANA : 08179813148", faketeks, but, mek)
break
case 'ovo':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "OVO : 085894327468", faketeks, but, mek)
break
